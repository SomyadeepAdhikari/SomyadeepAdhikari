...
<img src="https://skillicons.dev/icons?i=c,dart,flutter,js,ts,python,java,cpp,html,css,react,angular,nodejs,express,mongodb,mysql,postgresql,aws,gcp,docker,kubernetes,git,vscode,postman,figma,&theme=dark&perline=8" />
